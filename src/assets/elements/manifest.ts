...
export const ELEMENT_THEMES: ElementTheme[] = [
  ...
  makeTheme('flowers', 'Flowers', Flower2 as LucideIcon, 'text-pink-400', 'bg-pink-50', [
    { id: 'outline', label: 'Outline',  src: svgUri(`<ellipse cx="50" cy="21" rx="9" ry="16" fill="none" stroke="#db2777" stroke-width="2.5" transform="rotate(0 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="none" stroke="#db2777" stroke-width="2.5" transform="rotate(60 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="none" stroke="#db2777" stroke-width="2.5" transform="rotate(120 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="none" stroke="#db2777" stroke-width="2.5" transform="rotate(180 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="none" stroke="#db2777" stroke-width="2.5" transform="rotate(240 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="none" stroke="#db2777" stroke-width="2.5" transform="rotate(300 50 50)"/><circle cx="50" cy="50" r="12" fill="none" stroke="#db2777" stroke-width="2.5"/>`) },
    { id: 'filled',  label: 'Filled',   src: svgUri(`<ellipse cx="50" cy="21" rx="9" ry="16" fill="#f9a8d4" transform="rotate(0 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="#ec4899" transform="rotate(60 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="#f9a8d4" transform="rotate(120 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="#ec4899" transform="rotate(180 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="#f9a8d4" transform="rotate(240 50 50)"/><ellipse cx="50" cy="21" rx="9" ry="16" fill="#ec4899" transform="rotate(300 50 50)"/><circle cx="50" cy="50" r="13" fill="#fbbf24"/>`) },
    { id: 'daisy',   label: 'Daisy',    src: svgUri(`<ellipse cx="50" cy="20" rx="7" ry="14" fill="#fef08a" transform="rotate(0 50 50)"/><ellipse cx="50" cy="20" rx="7" ry="14" fill="#fde68a" transform="rotate(45 50 50)"/><ellipse cx="50" cy="20" rx="7" ry="14" fill="#fef08a" transform="rotate(90 50 50)"/><ellipse cx="50" cy="20" rx="7" ry="14" fill="#fde68a" transform="rotate(135 50 50)"/><ellipse cx="50" cy="20" rx="7" ry="14" fill="#fef08a" transform="rotate(180 50 50)"/><ellipse cx="50" cy="20" rx="7" ry="14" fill="#fde68a" transform="rotate(225 50 50)"/><ellipse cx="50" cy="20" rx="7" ry="14" fill="#fef08a" transform="rotate(270 50 50)"/><ellipse cx="50" cy="20" rx="7" ry="14" fill="#fde68a" transform="rotate(315 50 50)"/><circle cx="50" cy="50" r="14" fill="#f59e0b"/>`) },
    { id: 'rose',    label: 'Rose',     src: svgUri(`<ellipse cx="50" cy="21" rx="10" ry="17" fill="#fda4af" transform="rotate(0 50 50)"/><ellipse cx="50" cy="21" rx="10" ry="17" fill="#fb7185" transform="rotate(72 50 50)"/><ellipse cx="50" cy="21" rx="10" ry="17" fill="#fda4af" transform="rotate(144 50 50)"/><ellipse cx="50" cy="21" rx="10" ry="17" fill="#fb7185" transform="rotate(216 50 50)"/><ellipse cx="50" cy="21" rx="10" ry="17" fill="#fda4af" transform="rotate(288 50 50)"/><circle cx="50" cy="50" r="14" fill="#f43f5e"/><circle cx="50" cy="50" r="7" fill="#fb7185"/>`) },
  ]),
  ...
  makeTheme('moon', 'Moon', Moon as LucideIcon, 'text-indigo-400', 'bg-indigo-50', [
    ...
    { id: 'fullmoon', label: 'Full Moon',  src: svgUri(`<circle cx="50" cy="50" r="38" fill="#818cf8"/><circle cx="38" cy="38" r="7" fill="#6366f1" opacity="0.5"/><circle cx="60" cy="55" r="5" fill="#6366f1" opacity="0.4"/><circle cx="42" cy="62" r="4" fill="#6366f1" opacity="0.35"/><circle cx="62" cy="35" r="3" fill="#6366f1" opacity="0.4"/>`) },
  ]),
  ...
  makeTheme('hearts-stack', 'Hearts Stack', Layers as LucideIcon, 'text-rose-400', 'bg-rose-50', [
    { id: 'outline', label: 'Outline',    src: svgUri(`<path d="${HEART_PATH}" fill="none" stroke="#fb7185" stroke-width="3"/>`) },
    ...
    { id: 'trio',    label: 'Trio',       src: svgUri(`<path d="M50 82 C28 68, 15 56, 15 38 C15 23, 25 14, 37 14 C43 14, 48 17, 50 22 C52 17, 57 14, 63 14 C75 14, 85 23, 85 38 C85 56, 72 68, 50 82Z" fill="#f43f5e"/><g transform="translate(18,44) scale(0.7) translate(-28,-44)"><path d="M28 68 C14 57, 5 49, 5 37 C5 26, 12 20, 20 20 C24 20, 27 22, 29 26 C31 22, 34 20, 38 20 C46 20, 53 26, 53 37 C53 49, 42 57, 28 68Z" fill="#fda4af"/></g><g transform="translate(82,44) scale(0.7) translate(-72,-44)"><path d="M72 68 C58 57, 47 49, 47 37 C47 26, 54 20, 62 20 C66 20, 69 22, 71 26 C73 22, 76 20, 80 20 C88 20, 95 26, 95 37 C95 49, 86 57, 72 68Z" fill="#fda4af"/></g>`) },
  ]),
];
